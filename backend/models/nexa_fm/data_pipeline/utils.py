...
def deterministic_split(input_docs: List[Any], train_ratio: float = 0.8, seed: int = 42) -> Dict[str, List[Any]]:
    """Splits data into train/val sets deterministically by sorting on a stable key or value."""
    def get_id(x):
    ...
    return {'train': sorted_docs[:train_end], 'val': sorted_docs[train_end:]}
