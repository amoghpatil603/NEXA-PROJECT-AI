...
print("=== STARTING NEXA PHASE 4E TINY MODEL TRAINING ===")
...
# Model configuration for Nexa Tiny (12-15M parameters)
...
final_md = f"""# NEXA PHASE 4E — TINY MODEL TRAINING REPORT
=====================================================
...
- **Checkpoints**: Saved `latest.ckpt` and `best.ckpt` every {{train_config.save_every_steps}} steps. Automatic resume fully supported.
...
print("NEXA_TINY_TRAINING_STARTED")
